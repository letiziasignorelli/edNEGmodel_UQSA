...
if __name__ == '__main__': 
    ...
    data = UQ.quantify(seed=10, data_folder = "data/simulation_outputs/UQSA_pathological/phi_msn_1", plot=None)
    ...
    # We set the seed to easier be able to reproduce the result
    data = UQ.quantify(seed=10, data_folder = "data/simulation_outputs/UQSA_pathological/phi_msn_5", plot=None)
    ...
    # We set the seed to easier be able to reproduce the result
    data = UQ.quantify(seed=10, data_folder = "data/simulation_outputs/UQSA_pathological/phi_msn_10", plot=None)
    elapsed_time10 = round(time.time() - start_time, 5)

    # Open a text file in write mode
    with open("Figure6_7.txt", "w") as file:
