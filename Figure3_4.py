...
if __name__ == '__main__': 
    ...
    feature_list = un.SpikingFeatures(features_to_run=["nr_spikes", "spike_rate_steady", "time_before_first_spike"])
    ...
    data = UQ.quantify(seed=10, data_folder = "data/simulation_outputs/UQSA_physiological/phi_msn_1")
    ...
    # We set the seed to easier be able to reproduce the result
    data = UQ.quantify(seed=10, data_folder = "data/simulation_outputs/UQSA_physiological/phi_msn_5")
    ...
    # We set the seed to easier be able to reproduce the result
    data = UQ.quantify(seed=10, data_folder = "data/simulation_outputs/UQSA_physiological/phi_msn_10")