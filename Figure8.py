...
if __name__ == '__main__': 
    ...
    data = UQ.quantify(seed=10, rosenblatt=True, data_folder = "data/simulation_outputs/UQSA_pathological/K_se_1", plot=None)
    ...
    # We set the seed to easier be able to reproduce the result
    data = UQ.quantify(seed=10, rosenblatt=True, data_folder = "data/simulation_outputs/UQSA_pathological/K_se_5", plot=None)
    ...
    # We set the seed to easier be able to reproduce the result
    data = UQ.quantify(seed=10, rosenblatt=True, data_folder = "data/simulation_outputs/UQSA_pathological/K_se_10", plot=None)